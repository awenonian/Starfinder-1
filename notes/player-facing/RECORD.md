...
What happened, in play order. Append as you go — small bits during play, not a
write-up at the end. Never tidy it; the mess is the point.

Only what came from play goes here. If you're filling a gap with something
plausible, you've stopped recording and started inventing.

Quote the player rather than describing them. "I'd rather not say" is worth
more than *declined to answer*.
...
than my word, I think. But I'd be missing most of the story."*

She went for it — reading the microphone's entry correctly as a plantable bug
rather than something she'd have to hold. Plan: get close enough to toss it
behind the bulkhead, then back off, and listen from cover via the comm unit.

**Stealth +6, +1 circumstance for the idling engine, against Teren's Perception
DC 16. Rolled 3, total 10. Failure.**

Three strides into the light-gap, the dead pharmacy's broken motion plate
